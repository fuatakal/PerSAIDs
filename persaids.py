...
st.markdown("<h2 style='text-align: center; color: black;'>Please fill the form below and click the predict button to see <br/>how likely your patient has FMF.</h2>", unsafe_allow_html=True)
